...
$compliancenotify=$manager->compliancenotification();
$complianceseennotify=$manager->setnotifyintoseen();
              ...
              <div class="portlet box red">
                ...
                <div class="portlet-body ">               
                  <div class="row" style="overflow-y: scroll; position:relative; height: 500px;">
                    ...
                    <?php
                     foreach($compliancenotify as $compliance){ ?>
                             <?php if($compliance['notification_status']==1){ ?> 
                            <h5 style="padding: 25px; background-color: skyblue;">New <?php echo $compliance['name']; ?> is <?php echo $compliance['status']; ?> on <?php echo $compliance['created_date']; ?> <?php echo $compliance['notification_status']; ?></h5>
                            <?php } else { ?>
                              New <?php echo $compliance['name']; ?> is <?php echo $compliance['status']; ?> on <?php echo $compliance['created_date']; ?>
                            <?php } ?>


                             <input type="hidden" name="submit" id="company" value="<?php echo $compliance['id']?>">
                              <input type="hidden" name="submit" id="company_id" value="<?php echo $compliance['company_id']?>">
                               <hr>
                  <?php }  ?>
                  <?php
                    setnotifyintoseen();

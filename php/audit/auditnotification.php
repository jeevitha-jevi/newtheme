...
$auditornotify=$manager->auditornotification();
$auditseennotify=$manager->setnotifyintoseen();
  ...
  <body style="font-family: sans-serif !important;">
   <body>
      ...
      ?>
               ...
               <div class="page-content-wrapper" style="width: 93%; margin-left: 15px;">                
              ...
              <div class="portlet box red">
                ...
                <div class="portlet-body ">               
                  <div class="row" style="overflow-y: scroll; position:relative; height: 500px;">
                    ...
                    <?php
                     foreach($auditornotify as $notify){ ?>
                             <?php if($notify['notification_status']==1){ ?> 
                            <h5 style="padding: 25px; background-color: skyblue;">New <?php echo $notify['title']; ?> is <?php echo $notify['status']; ?> on <?php echo $notify['created_date']; ?> <?php echo $notify['notification_status']; ?></h5>
                            <?php } else { ?>
                              New <?php echo $notify['title']; ?> is <?php echo $notify['status']; ?> on <?php echo $notify['created_date']; ?>
                            <?php } ?>


                             <input type="hidden" name="submit" id="company" value="<?php echo $notify['id']?>">
                              <input type="hidden" name="submit" id="company_id" value="<?php echo $notify['company_id']?>">
                               <hr>
                  <?php }  ?>
                  <?php
                    setnotifyintoseen();

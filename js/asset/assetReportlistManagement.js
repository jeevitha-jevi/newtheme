$(document).ready(function () {
    ...
    $.ajax({
        dataType: "json",
        type: "POST",
        url: "/freshgrc/php/asset/assetReportlist.php",
...
function buildHtmlTable(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        for (var colIndex = 0; colIndex < columns.length; colIndex++) {
            ...
            if (colIndex == 6 && "reviewed" == auditstatus){
              cellValue="reviewed";
...
function performAssetActions() {
    var selectedData = table.rows('.selected').data();
    if(selectedData[0][6]=="reviewed"){
    window.location = "/freshgrc/view/asset/assetReport.php?assetId=" + selectedData[0][0];
}
else{
     alert("Please complete full flow otherwise you can't generate Report.");
}

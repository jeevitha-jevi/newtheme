...
function buildHtmlTable(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        for (var colIndex = 0; colIndex < columns.length; colIndex++) {
            ...
            if (colIndex == 6 && "identified" == auditstatus){
              cellValue="identified";
...
function performAssetReturnActions() {
    var selectedData = table.rows('.selected').data();
    if(selectedData[0][6]=="assessment returned"){
    window.location = "/freshgrc/view/asset/assetReviewAction.php?assetId=" + selectedData[0][0];
}
 
}
function performAssetReturnHistory() {
    var selectedData = table.rows('.selected').data();
    
    window.location = "/freshgrc/view/asset/assetHistory.php?assetId=" + selectedData[0][0];

$(document).ready(function () {
    ...
    $.ajax({
        dataType: "json",
        type: "POST",
        url: "/freshgrc/php/audit/auditPerformList.php",
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        for (var colIndex = 0; colIndex < columns.length; colIndex++) {
            ...
            if (colIndex == 8 && "approved" == auditstatus){
              ...
              cellValue="Performed";
              row$.append($('<td class="btn" style="width:114px; height:50% ; background-color:#3bc5d2;color:#000; margin: 10px;"/>').html(cellValue));   
            }

$(document).ready(function () {
    ...
    $.ajax({
        dataType: "json",
        type: "POST",
        url: "/newtheme/php/audit/auditPublishList.php",
...
function tableInit() {
  table = $('#modaldetails').DataTable({
        ...
        buttons: [
            ...
            { extend: 'csv', className: 'btn purple btn-outline ' ,text: '<img src="/newtheme/assets/images/csv.png" alt=csv width="20" height="20" data-toggle="tooltip" title="CSV"/>'},
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        for (var colIndex = 0; colIndex < columns.length; colIndex++) {
            ...
            if (colIndex == 6 && "approved" == auditstatus){
              ...
              row$.append($('<td  style="width:80px; height:50% ; background-color:#32c5d2; color:#fff; margin: 10px;"/>').html(cellValue));   
            }
              ...
              row$.append($('<td  class="btn" style="width:80px; height:50% ; background-color: #00a8ff; color:#fff;margin: 10px;"/>').html(cellValue));   
            }
              ...
              row$.append($('<td class="btn" style="width:80px; height:50% ; background-color:red; color:#fff; margin: 10px;"/>"').html(cellValue));   
            }
            else
           {
...
function auditList(){
     window.location="/newtheme/view/audit/auditorAdmin.php";
}

$(document).ready(function () {
    ...
    $.ajax({
        dataType: "json",
        type: "POST",
        url: "/newtheme/php/audit/auditPrepareList.php",
...
function performAuditActions() {
 var selectedData = table.rows('.selected').data();
    if(selectedData[0][8]=="Audit Launched"){

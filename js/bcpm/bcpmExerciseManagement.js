$(document).ready(function () {
    ...
    $.ajax({
        dataType: "json",
        type: "POST",
        url: "/freshgrc/php/bcpm/bcpmExerciseList.php",
...
function buildHtmlTable(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        for (var colIndex = 0; colIndex < columns.length; colIndex++) {
            ...
            if (colIndex == 6 && "maintainancedone" == auditstatus){
              cellValue="maintainancedone";
...
function performBcpmAction() {
    var selectedData = table.rows('.selected').data();
    if(selectedData[0][6]=="maintainancedone"){
    window.location = "/freshgrc/view/bcpm/bcpmexercise.php?bcpmId=" + selectedData[0][0];
}

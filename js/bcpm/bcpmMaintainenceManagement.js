$(document).ready(function () {
    ...
    $.ajax({
        dataType: "json",
        type: "POST",
        url: "/freshgrc/php/bcpm/bcpmMaintainancelist.php",
...
function buildHtmlTable(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        for (var colIndex = 0; colIndex < columns.length; colIndex++) {
            ...
            if (colIndex == 6 && "implemented" == auditstatus){
              cellValue="implemented";
...
function performBcpmAction() {
    ...
    var selectedData = table.rows('.selected').data();
    debugger
    if(selectedData[0][6]=="implemented"){
    window.location = "/freshgrc/view/bcpm/bcpmmaintenance.php?bcpmId=" + selectedData[0][0];
}

$(document).ready(function () {     
    ...
    $.ajax({
        dataType: "json",
        type: "POST",
        url: "/freshgrc/php/ethics/getdataforReport.php",
...
function addAllColumnHeaders(data) {
 ...
 function getdataforreport() {
    ...
    if (length>0) {
         window.location = "/freshgrc/view/ethics/Reportforethics.php?PolicyId=" + selectedData[0][0];
    }

        
}

function getalldataforethics()
{
var userCredentials = {
        'userId' : loggedInUser,
        'userRole' : loggedInUserRole

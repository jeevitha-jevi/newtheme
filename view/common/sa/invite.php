...
<div class="kt-header__topbar">
   ...
   <div class="kt-header__topbar-item dropdown">
         ...
         <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px" aria-expanded="true" title="project&task">
           <span class="kt-header__topbar-icon"><i class="flaticon-feed"></i></span>
...
<div class="kt-header__topbar-item kt-header__topbar-item--langs">
   <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
     <span class="kt-header__topbar-icon" title="logout" >
...
<?php foreach ($allUsersArray as $data) { ?>
                    ...
                    <td><?php echo $data['role'];?></td>
                       <td><button class="btn btn-primary"><a href="/newtheme/view/common/invite.php?auditId=<?php echo $data['id']; ?>" style="color: white;">Invite</a></button></td>

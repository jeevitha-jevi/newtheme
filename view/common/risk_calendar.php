...
<div id='calendar' style="width: 50%;height: 50%;margin-left: 70px;"></div>
<script>
    $(document).ready( function() {
        $.ajax({
            dataType: "json",
            contentType: 'application/json',
            url: "php/risk/riskDataforCalendar.php",
            data: "",
...
for(i=0;i<data.length;i++)
     {
     chartData.push({"title":data[i].subject,"start":data[i].created_date});
      }
  console.log(data);

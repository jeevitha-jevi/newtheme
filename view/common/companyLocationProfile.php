            ...
            padding-right: 20px;">
              <ul class="nav">
               <!--  <li >
                ...
                <li class="active">
                  <a href="view/superadmin/companyLocationAdmin.php">
                  <i class="glyphicon glyphicon-home"></i>
                                    ...
                                    <div class="cont-col2">
                                        ...
                                        <div class="desc" id="feed<?php echo $auditId ?>"> New Audit is assigned for <?php echo $feed['last_name'] ?>     <?php echo $feed['title'] ?> 
                                            <span class="label label-sm label-info">
                                                <a  <?php if($feed['status']=="create") {?> href="view/audit/auditDoPage.php?auditId=<?php echo $feed['id'] ?>" <?php }?>  <?php if($feed['status']=="prepared") {?> href="view/audit/auditeeDoPage.php?auditId=<?php echo $feed['id'] ?>" <?php }?> <?php if($feed['status']=="performed") {?> href="view/audit/auditCheckPage.php?auditId=<?php echo $feed['id'] ?>" <?php }?> <?php if($feed['status']=="returned") {?> href="view/audit/auditActPage?auditId=<?php echo $feed['id'] ?>" <?php }?>> Take action</a>
                                            </span>
                                        </div>
                                    </div>
                                </div>
...
{ 
 include "../superadmin/companyLocationAdmin.php" ; 
}

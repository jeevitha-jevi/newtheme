...
<head lang="en">
  ...
  <link rel="stylesheet" type="text/css" href="assets/DataTables/datatables.min.css" />
    ...
    <script src="js/compliance/complianceReviewManagement.js"></script>
...
|| $_SESSION['user_role'] == 'compliance_author'
       </div> -->
          <div class="portlet-body ">
            <?php if($_SESSION['user_role'] == 'compliance_reviewer' || $_SESSION['user_role'] == 'compliance_author' || $_SESSION['user_role'] == 'super_admin') {?>
                <div class="row">
                    
                   
                    <div class="col-xs-2" id="manageCompl">
                        <button class="btn btn-error btn-block" style="width:106px; background-color:#50C878;" onclick="showComplClause()"><i class="fa fa-list"></i>  Review</button>
                    </div>

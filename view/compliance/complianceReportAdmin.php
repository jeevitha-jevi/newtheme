...
<head lang="en">
    ...
    <title>ComplianceReportAdmin</title>
    <base href="/freshgrc/">
            ...
            <?php if($_SESSION['user_role'] == 'compliance_author' || $_SESSION['user_role'] == 'super_admin') {?>
                <div class="row">
                    ...
                    <div class="col-xs-2" id="manageCompl">
                        <button class="btn btn-error btn-block" style="width:160px;background-color:#50C878;" onclick="showComplClause()"><i class="fa fa-list"></i>Report</button>
                    </div>
                    <!-- <div class="col-xs-2">                      

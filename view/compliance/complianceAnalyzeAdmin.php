...
<head lang="en">
    ...
    <title>ComplianceAnalyzeAdmin</title>
    <base href="/freshgrc/">
  ...
  <link rel="stylesheet" type="text/css" href="assets/DataTables/datatables.min.css" />
    ...
    <script src="js/compliance/complianceAnalyzeManagement.js"></script>
    ...
    <style>
        ...
        .panel{
          ...
          border: 1px saveComplianced #32c5d2;
          margin-bottom: 20px;
      ...
      <!--   <div id="viewdata" class="panel" style="margin-left: 10%;" >
        <div class="panel-heading text-center" style=" background-color: #5bc0de;     ">My Audits
          ...
          <div class="portlet-body ">
            ...
            <?php  if($_SESSION['user_role'] == 'grcadmin' || $_SESSION['user_role'] == 'compliance_author' || $_SESSION['user_role'] == 'compliance_reviewer' || $_SESSION['user_role'] == 'super_admin') {?>
                    <div class="col-xs-2" style="width: 200px;" >
                        <button class="btn btn-error btn-block" style="background-color:#50C878;" onclick="showComplClause()"><i class="fa fa-list"></i>Analyze</button>
                    </div>
            <?php } ?>

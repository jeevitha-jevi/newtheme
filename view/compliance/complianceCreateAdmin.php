...
<body>
          ...
          <div class="portlet-body ">
            <?php if($_SESSION['user_role'] == 'compliance_author' || $_SESSION['user_role'] == 'super_admin') {?>
                <div class="row">
                    ...
                    <div class="col-xs-2" id="newCompl" style="width:100px;">
                        <button class="btn btn-warning btn-block" onclick="showModal(false)"><i class="fa fa-plus-circle"></i> New</button>
                    </div>
                    <div class="col-xs-2" id="editCompl" style="width:100px;">
                        <button class="btn btn-success btn-block" onclick="showModal(true)"><i class="fa fa-pencil-square"></i>  Edit</button>
                    </div>

                     <div class="col-xs-2" id="editCompl" style="width:170px;">
                        <button class="btn btn-success btn-block" onclick="showDeleteDialog()"><i class="fa fa-pencil-square"></i>  Delete</button>
                    </div>
                    <div class="col-xs-2" id="manageCompl" style="width: 200px;">
                        <button class="btn btn-error btn-block" style=" background-color:#50C878;" onclick="showComplClause()"><i class="fa fa-list"></i>Manage Clauses</button>
                    </div>
                    <div class="col-xs-2" id="importCompl" style="width: 170px;">                      
  ...
  <div class="col-xs-2" style="width: 200px;">                      
                            ...
                            <i class="btn btn-danger btn-block fa fa-file-excel-o"> <a href="view/compliance/complianceUcfview.php">View Library</a></i>
                                              
                    </div>
                    <div class="col-xs-2" style="width: 170px;">                      
                        
                            <i class="btn btn-danger btn-block fa fa-file-excel-o" onclick="insertData()"> Add Library</i>
...
<div>
            ...
            <?php } else if($_SESSION['user_role'] == 'grcadmin' || $_SESSION['user_role'] == 'compliance_reviewer') {?>
                    <div class="col-xs-2" id="editCompl" style="width: 150px;">

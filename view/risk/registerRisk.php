...
<head lang="en">
    ...
    <script src="js/risk/registerRisk.js"></script>
    ...
    <div class="portlet-body ">
            <?php if($_SESSION['user_role'] == 'risk_mitigator') {?>
                <div class="clearfix" id="mitigator1">
                   ...
                   <select class="btn btn-primary" id="sortbypriority" style="margin-left: 20px;margin-top: 10px;">
                    ...
                    <button class="btn btn-primary" onclick="displayReport()" style="margin-left: 20px;margin-top: 10px;"><i class="fa fa-file"></i> Report</button>
                </div>
            <?php }?>             

...
<head lang="en">
    ...
    <script src="js/risk/mitigatedriskManagement.js"></script>
    ...
    <div class="portlet-body ">
           <?php if($_SESSION['user_role'] == 'risk_reviewer') {?>
                <div class="col-xs-2" id="reviewer1">
                    <button class="btn btn-primary" style="margin-left: 20px;" onclick="showRiskReview()"><i class="fa fa-user"></i>Review</button>
                </div>                
            <?php }?>                

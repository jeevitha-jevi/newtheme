...
<head lang="en">
    ...
    <script src="js/risk/createdriskManagement.js"></script>
...
<body class="with-side-menu-compact">
    ...
    <div class="portlet-body ">
            <?php if($_SESSION['user_role'] == 'risk_mitigator') {?>
                <div id="mitigator1">
                    <button class="btn btn-primary" style="margin-left: 20px;margin-top: 10px;" onclick="showRiskMitigation()"><i class="fa fa-user"></i>Mitigate</button>
                    <button class="btn btn-primary" style="margin-left: 20px;margin-top: 10px;" onclick="loadRiskByDate()"><i class="fa fa-calendar"></i>Sort By Date</button>
                    <button class="btn btn-primary" style="margin-left: 20px;margin-top: 10px;" onclick="loadRiskByPrio()"><i class="fa fa-calendar"></i>Sort By Priority</button>

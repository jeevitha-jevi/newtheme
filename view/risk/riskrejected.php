...
<head lang="en">
    ...
    <script src="js/risk/riskrejectedmanagement.js"></script>
...
<select class="btn btn-primary" onchange="location = this.value;" style="margin-left: 20px;">
                      <option disabled selected>RiskResult </option>
                      <option value="view/risk/registerRisk.php">All Risk</option>
                      <option value="view/risk/riskaccept.php">Accept</option>
                      <option value="view/risk/riskrejected.php">Reject</option>
                    </select>

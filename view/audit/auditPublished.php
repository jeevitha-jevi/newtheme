...
<?php foreach ($allAudits as $data) { ?>
                    ...
                    <td><button class="btn btn-success"><a href="/newtheme/view/audit/auditReprt.php?auditId=<?php echo $data['auditId']; ?>" style="color: white;">Report</a></button></td>
...
include 'sidemenu.php';
 ?>
    ...
    <!--begin:: Global Mandatory Vendors -->
    <script type="text/javascript" src="js/audit/auditPublishManagement.js"></script>

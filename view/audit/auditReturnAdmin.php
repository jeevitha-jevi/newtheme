<?php
 require_once __DIR__.'/../header.php';
  require_once __DIR__.'/../../php/audit/auditManager.php';
    ...
    $allAudits = $manager->getAllAuditsForReturned($userId, $userRole);
...
<?php foreach ($allAudits as $data) { ?>
                    ...
                    <td><button class="btn btn-warning"><a href="/newtheme/view/audit/auditActPage.php?auditId=<?php echo $data['auditId']; ?>" style="color: white;">Followup</a></button></td>
...
include 'sidemenu.php';
 ?>
        ...
        <script src="js/audit/auditReturnManagement.js"></script>
        <script>

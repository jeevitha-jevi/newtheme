<?php
 require_once __DIR__.'/../header.php';
  require_once __DIR__.'/../../php/audit/auditManager.php';
    ...
    $allAudits = $manager->getAllAuditsForPrepared($userId, $userRole);
...
<?php foreach ($allAudits as $data) { ?>
                    ...
                    <td><button class="btn btn-success"><a href="/newtheme/view/audit/auditeeDoPage.php?auditId=<?php echo $data['auditId']; ?>" style="color: white;">Respond</a></button></td>
...
include 'sidemenu.php';
 ?>
        ...
        <script src="js/audit/auditPerformManagement.js"></script>
        <script>

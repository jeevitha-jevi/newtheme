 ...
 require_once __DIR__.'/../header.php';
  require_once __DIR__.'/../../php/audit/auditManager.php';
   $manager = new AuditManager();
    ...
    $allAudits = $manager->getAllAuditsForPerformed($userId, $userRole);
...
<?php foreach ($allAudits as $data) { ?>
                    ...
                    <td><button class="btn btn-danger"><a href="/newtheme/view/audit/auditCheckPage.php?auditId=<?php echo $data['auditId']; ?>" style="color: white;">Review</a></button></td>
